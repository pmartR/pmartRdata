...
#'
#' @format A isobaricpepData object (see \code{\link[pmartR]{as.isobaricpepData}} for details)
#' \describe{
...
#'
#' A dataset containing the quantified mass spectra for 146 lipids collected on a Thermo LTQ-Orbitrap Velos Mass Spectrometer (Thermo Fisher Corporation, San Jose, CA, USA) in positive ion mode.
#'
...
#'
#' @format A lipidData object (see \code{\link[pmartR]{as.lipidData}} for details)
#' \describe{
...
#'
#' An S3 object of class metabData (see \code{\link[pmartR]{as.metabData}} for details)
#'
...
#'
#' An S3 object of class pepData (see \code{\link[pmartR]{as.pepData}} for details)
#'
...
#'
#' A dataset containing the quantified mass spectra for 5,244 unique mass tag identifiers and 3646 unique proteins from a study examining the effect of inhalation endotoxin exposure and obesity on lung inflammation in mice.  This is a subset taken from the full data.
#'
...
#'
#' @format A data.frame with 12328 rows (mass tags) and 17 columns (mass tag and sample columns):
#' \describe{
#'   \item{Mass_Tag_ID}{Peptide mass tag identifier}
...
#' Peptide-level Sample Feature Data (f_data) from a cancer/obesity study on mice.
#'
#' A dataset containing the sample metadata from a study examining the effect of inhalation endotoxin exposure and obesity on lung inflammation in mice.  This is a subset taken from the full data.
#'
#' @references Tilton, S. C.; Waters, K. M.; Karin, N. J.; Webb-Robertson, B. J.; Zangar, R. C.; Lee, K. M.; Bigelow, D. J.; Pounds, J. G.; Corley, R. A., \emph{Diet-induced obesity reprograms the inflammatory response of the murine lung to inhaled endotoxin}. Toxicol Appl Pharmacol 2013, 267 (2), 137-48.
#'
#' @format A data.frame with 16 rows (samples) and 2 columns (sample names and group assignment):
#' \describe{
#'   \item{SampleID}{Sample identifier (matches column headers in pep_edata)}
...
#'
#' A dataset containing the peptide metadata (e.g. mapping from peptide to proteins) from a study examining the effect of inhalation endotoxin exposure and obesity on lung inflammation in mice.  This is a subset taken from the full data.
#'
#' @references Tilton, S. C.; Waters, K. M.; Karin, N. J.; Webb-Robertson, B. J.; Zangar, R. C.; Lee, K. M.; Bigelow, D. J.; Pounds, J. G.; Corley, R. A., \emph{Diet-induced obesity reprograms the inflammatory response of the murine lung to inhaled endotoxin}. Toxicol Appl Pharmacol 2013, 267 (2), 137-48.
#'
...
#' Protein-level Data Object of Class pepData from a cancer/obesity study on mice.
#'
#' An S3 object of class pepData (see \code{\link[pmartR]{as.pepData}} for details) from a study examining the effect of inhalation endotoxin exposure and obesity on lung inflammation in mice.  This is a subset taken from the full data.
#'
#' @references Tilton, S. C.; Waters, K. M.; Karin, N. J.; Webb-Robertson, B. J.; Zangar, R. C.; Lee, K. M.; Bigelow, D. J.; Pounds, J. G.; Corley, R. A., \emph{Diet-induced obesity reprograms the inflammatory response of the murine lung to inhaled endotoxin}. Toxicol Appl Pharmacol 2013, 267 (2), 137-48.
#'
#' @format A pepData object
...
#'
#' An S3 object of class proData (see \code{\link[pmartR]{as.proData}} for details)
#'
